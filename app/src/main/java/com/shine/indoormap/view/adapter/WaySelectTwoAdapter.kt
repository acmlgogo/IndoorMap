...
class WaySelectTwoAdapter(content: Context?, var data: WayData.ResultDataEntity.WalkMethodTwoDataEntity?, var type: TypeSelect) : RecyclerView.Adapter<WaySelectTwoAdapter.ViewHolder>() {
...
//        loadWayTypeImage(mContext, holder.mTypeIm, data!!.walkData.get(position).type)
