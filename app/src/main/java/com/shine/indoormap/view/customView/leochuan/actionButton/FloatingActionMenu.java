package com.shine.indoormap.view.customView.leochuan.actionButton;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = Util.dpToPx(getContext(), 10f);
...
//        mMenuColorPressed = attr.getColor(R.styleable.FloatingActionMenu_menu_colorPressed, 0xFFE75043);
        mMenuColorNormal = attr.getColor(R.styleable.FloatingActionMenu_menu_colorNormal, 0xFF35bab0);
        mMenuColorPressed = attr.getColor(R.styleable.FloatingActionMenu_menu_colorPressed, 0xFF35bab0);
